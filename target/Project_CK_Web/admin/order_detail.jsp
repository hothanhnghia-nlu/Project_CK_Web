              ...
              <div class="x_panel">
                <div class="x_title">
                  <div class="row element-button">
                    <div class="pl-3">
                      <a class="btn btn-print btn-sm print-file" type="button" title="In" style="border: 2px solid #bdc3c7">
                        <i class="fas fa-print"></i> In dữ liệu</a>
                    </div>
                    <div class="pl-3">
                      <a class="btn btn-delete btn-sm delete-all" type="button" title="Xóa" style="border: 2px solid #bdc3c7">
                    ...
                    <div class="col-sm-12">
                      <div class="card-box table-responsive">
                        <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                          ...
                          <tbody>
                            <c:forEach items="${orderList}" var="x">
                              <tr>
                                <td>${x.order_id}</td>
                                <td>${x.name}</td>
                                <td>${x.quantity}</td>
