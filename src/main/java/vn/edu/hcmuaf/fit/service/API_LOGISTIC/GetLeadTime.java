...
public class GetLeadTime {
    public static String getLeadTime(String token, String from_district_id, String from_ward_id, String to_district_id, String to_ward_id) throws IOException, IOException {
...
//        String weight = "100";
//
//        // Create request to calculate transport fee to API
