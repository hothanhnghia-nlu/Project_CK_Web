                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  method="post">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" id="first-name" required="required" class="form-control" name="namep" value="<%=p.getName()%>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        ...
                                        <select class="col-form-label col-md-3 col-sm-3 form-control" tabindex="0" required="required" name="id_cate">
                                            <option></option>
                                            <% for(Category c : cate){%>
                                            <option value="<%=c.getCategoryID()%>" <%=(c.getCategoryID().equals(p.getCat_id())?"selected":"")%>><%=c.getName()%></option>
                                            <%}%>
                                        </select>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input for="middle-name" class="form-control" required="required" type="number" name="quantity" value="<%=p.getQuantity()%>">
                                    </div>
                                </div>
                                <div class="item form-group">
