        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                <ul class="nav side-menu">
                    <li><a href="#"><i class="fa fa-chart-line"></i> Thống kê</a></li>
                    ...
                    <li><a> <i class="fa fa-list"></i> Quản lý sản phẩm <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="product-list"><i class="fa fa-list"></i> Quản lý sản phẩm</a></li>
                    ...
                    <li><a><i class="fa fa-sticky-note"></i> Quản lý bình luận <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="comment"><i class="fa fa-comment"></i> Đánh giá sản phẩm</a></li>
                            <li><a href="contacts"><i class="fa fa-contact-book"></i> Liên hệ</a></li>
                        </ul>
                    </li>
                    <li><a href="order-list"><i class="fa fa-cart-shopping"></i> Quản lý đơn hàng</a></li>
                    <li><a href="logs"><i class="fa fa-book"></i> Quản lý nhật ký</a></li>
                </ul>
            </div>
        </div>
        <!-- /sidebar menu -->
