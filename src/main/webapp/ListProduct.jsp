								...
								<div class="aside">
									...
									<div class="checkbox-filter">
										...
										<div class="input-checkbox">
											<input type="checkbox" id="category-<%=p.getCategoryID()%>" name="cateID" value="<%=p.getCategoryID()%>" >
								...
								<div class="aside">
									...
									<div class="product-widget">
										...
										<div class="product-body">
											<p class="product-category"><%=p.getBrand()%></p>
								...
								<div class="row">
									...
									<div class="col-md-4 col-xs-6">
										<div class="product">
											...
											<div class="product-body">
												<p class="product-category"><%=p.getBrand()%></p>
												<h3 class="product-name"><a href="detail?pid=<%=p.getProductID()%>"><%=p.getName()%></a></h3>
